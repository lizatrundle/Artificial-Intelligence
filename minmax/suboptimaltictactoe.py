...
class TicTacToe():
    def __init__(self, grid=[['_','_','_'],['_','_','_'],['_','_','_']]):
    ...
    def __minimax_max(self, alpha, beta):
        ...
        if winner == 'X':
            return (-1, 0, 0)  # X is a Min player, the value of its best play is -1
        elif winner == 'O':
            return (1, 0, 0)   # O is a Max player, the value of its best play is 1
        elif winner == '_':
        ...
        for i in range(0, 3):
            for j in range(0, 3):
                if self._grid[i][j] == '_':
                    ...
                    (value, min_x, min_y) = self.__minimax_min(alpha, beta)
        ...
        for i in range(0, 3):
            for j in range(0, 3):
                if self._grid[i][j] == '_':
                    ...
                    (value, max_x, max_y) = self.__minimax_max(alpha, beta)
    ...
    def play(self):
        while True:
            ...
            if self._player_turn == 'X':
                ...
                (value, px, py) = self.__minimax_max(-2, 2)
...
if __name__ == "__main__":
    ...
    print("\nTotal states evaluated without pruning:", g.game_counter)
